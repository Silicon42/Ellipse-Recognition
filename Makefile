...
CFLAGS += -g -O0 -Wall -Wextra -Werror -Wno-shift-negative-value -Wno-implicit-fallthrough -Wno-error=comment -Wno-error=unused-variable -Wno-error=deprecated-declarations -DCL_TARGET_OPENCL_VERSION=120
